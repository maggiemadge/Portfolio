...
const NavbarLinks = () => {
    return (
        // <ul className="flex  gap-6 text-white font-body  text-center left-[50%] -translate-x-[50%] lg:text-md sm:text-xl sm:bg-cyan/30 backdrop-blur-lg lg:bg-black sm:w-full py-4">
            ...
            {links.map((link, index) => {
                return (
                    <li key={index} className="group">
                        ...
                        >
                       <a href="#" cursor="pointer" text-white hover  >{link.link}</a>
                        </Link>
